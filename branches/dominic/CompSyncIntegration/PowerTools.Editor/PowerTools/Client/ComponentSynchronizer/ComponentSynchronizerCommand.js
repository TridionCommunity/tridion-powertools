...
PowerTools.Commands.ComponentSynchronizer.prototype._execute = function (selection)
{
    ...
    this._popup = $popup.create(
                        PopUpUrl, 
                        "toolbar=no,width=750px,height=630px,resizable=false,scrollbars=false", 
                        { sel: selection, schema: this._currentSchema, pub: this._currentPublication, folder: this._rootFolder });
