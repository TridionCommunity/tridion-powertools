...
PowerTools.Popups.WorkflowNotificationSettings = function WorkflowNotificationSettings$constructor(element) 
{
...
PowerTools.Popups.WorkflowNotificationSettings.prototype.initialize = function WorkflowNotificationSettings$initialize() 
{
    ...
    var onSuccess = this.getDelegate(this.showCurrentSettings);
    ...
    PowerTools.Model.Services.AppDataServices.Read("code.google.com/p/tridion-notification-framework", currentUser["@ID"], onSuccess, this.getErrorHandler(), null, false);
};

//Populates the TextArea field with the Notification AppData, and enable the save button
PowerTools.Popups.WorkflowNotificationSettings.prototype.showCurrentSettings = function WorkflowNotificationSettings$showCurrentSettings(result) 
{
...
PowerTools.Popups.WorkflowNotificationSettings.prototype._saveAppData = function WorkflowNotificationSettings$_saveAppData() 
{
    //Set the callback function
    var onSuccess = this.getDelegate(this._handleSave);
    ...
    PowerTools.Model.Services.AppDataServices.Save("code.google.com/p/tridion-notification-framework", uriCurrentUser, data, onSuccess, this.getErrorHandler());
};

//Handles the Save reponse
PowerTools.Popups.WorkflowNotificationSettings.prototype._handleSave = function WorkflowNotificationSettings$_handleSave(result)
{
