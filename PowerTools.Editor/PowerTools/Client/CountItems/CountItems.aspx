...
<asp:Content ID="CountItems" ContentPlaceHolderID="Main" ClientIDMode="Static" runat="server">
	<div id="CountItems">
		<div class="tool-explanation">
			Counts items in a Publication, Structure Group or Folder. <br/>
			Select the types of items to count.
		</div>
		<hr class="br" />
		<table>
			<tr>
