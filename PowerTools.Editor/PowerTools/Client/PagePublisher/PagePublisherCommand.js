...
PowerTools.Commands.PagePublisher = function PagePublisherCommand$constructor()
{
    Type.enableInterface(this, "PowerTools.Commands.PagePublisher");
    this.addInterface("PowerTools.BaseCommand", ["PagePublisher"]);
};

PowerTools.Commands.PagePublisher.prototype._execute = function PagePublisherCommand$_execute(selection) 
{
    ...
    var popup = $popup.create(url, "toolbar=no,width=750px,height=518px,resizable=false,scrollbars=false", null);
    if (popup) popup.open();
};

PowerTools.Commands.PagePublisher.prototype._getSelectedItemId = function PagePublisherCommand$_getSelectedItemId(selection) 
{
...
PowerTools.Commands.PagePublisher.prototype.isValidSelection = function PagePublisherCommand$isValidSelection(selection)
{
