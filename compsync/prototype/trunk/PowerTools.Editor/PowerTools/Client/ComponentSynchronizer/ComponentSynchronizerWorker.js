...
PowerTools.ComponentSynchronizerWorker.prototype.execute = function (sel, ref)
{
    ...
    // prepare UI
    //JAIME: NOT NEEDED: $j('#tbody').html("<tr class=\"row0\"><td colspan=\"3\">Loading...</td></tr>");
    ...
    PowerTools.Model.Services.ComponentSynchronizer.Execute(sel, ref);
};
...
PowerTools.ComponentSynchronizerWorker.prototype._getData = function (id) {
    if (id != "") {
        alert('Done!');
    }
};
...
PowerTools.ComponentSynchronizerWorker.prototype._handleDataResponse = function (response)
{
    var p = this.properties;
    var content = "";
    var i = 0;
