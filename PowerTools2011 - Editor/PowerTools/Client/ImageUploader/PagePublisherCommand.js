...
PowerTools2011.Commands.PagePublisher = function ()
{
    Type.enableInterface(this, "PowerTools2011.Commands.PagePublisher");
    this.addInterface("Tridion.Cme.Command", ["PagePublisher"]);
    this.addInterface("PowerTools2011.ToolBase", ["PagePublisher"]);
};

PowerTools2011.Commands.PagePublisher.prototype.isAvailable = function (selection) {
...
PowerTools2011.Commands.PagePublisher.prototype.isEnabled = function (selection) {
    return this._defineEnabled();
};

PowerTools2011.Commands.PagePublisher.prototype._execute = function (selection)
{
    ...
    var PopUpUrl = $ptUtils.expandPath("/PowerTools/Client/PagePublisher/PagePublisher.aspx") + "#folderId=" + uriSelection;
    var popup = $popup.create(PopUpUrl, "toolbar=no,width=600,height=400,resizable=false,scrollbars=false", null);
    popup.open();
};

PowerTools2011.Commands.PagePublisher.prototype._defineEnabled = function () {
